...
import { BLOGS_FILE, MENUS_FILE } from "../../constants/file-paths";
...
const BlogDetail: FC<BlogDetailProps> = ({ menus, blog, relatedBlogs }) => {
  return (
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-9">
              ...
              />
              <Text fontSize="sm">
                Some Content will come here with Some Action{" "}
                <Text as="a" color="primary" fontSize="sm">
                  Send Enquiry
                </Text>
              </Text>
              <Spacer direction="vertical" size={25} />
            ...
            <div className="col-12 col-md-3">
              <div style={{ backgroundColor: '#303765', padding: '30px 20px' }}>
                <Text fontSize="lg" color="white">Ensure your loved ones and property are protected</Text>
                <Spacer direction="vertical" size={25} />
                <Button size="lg" rounded block backgroundColor="white" color="primary">Start my service</Button>
              </div>
