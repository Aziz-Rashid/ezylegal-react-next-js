...
const ProcessStepBox: FC<ProcessStepBoxProps> = ({ data }) => {
    ...
    return (
        <div className="container">
            <Text fontSize="xxxl" fontFamily="montserrat">Registration Process</Text>
                        ...
                        <ProcessStepItem key={i}>
                            <div className="row">
                                <div className="col-auto">
                                    <CircledText backgroundColor="skyBlue" size="sm">{i + 1}</CircledText>
                                </div>
                                <div className="col pl-0">
                                    <Text fontSize="sm">{processStep.step}</Text>
                                </div>
                            </div>
                        </ProcessStepItem>
                    ))
